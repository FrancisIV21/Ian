...
const Hero = () => {
  const [clipX, setClipX] = useState(50); // start half-half
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          ...
          <Image
            ...
            width={500}
            height={500}
            className="absolute inset-0 z-20 transition-all duration-150 ease-linear"
            style={{
          ...
          <Image
            src="/images/notanimated-bg.png"
            alt="NotAnimated background"
            fill
          ...
          {/* Floating labels */}
          <motion.span
            className="absolute left-6 top-6 font-suisse-mono text-xl tracking-wider text-black z-30"
            animate={{ 
              opacity: clipX / 100,
              y: [0, -5, 0],
            }}
          ...
          <motion.span
            className="absolute right-6 top-6 font-suisse-mono text-xl tracking-wider text-black z-30"
            animate={{ 
              opacity: 1 - clipX / 100,
              y: [0, -5, 0],
            }}
